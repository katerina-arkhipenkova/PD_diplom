    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('order_state', models.CharField(choices=[('basket', 'В корзине'), ('new', 'Новый заказ'), ('confirmed', 'Заказ подтвержден'), ('assembled', 'Заказ собран'), ('sent', 'Заказ отправлен'), ('delivered', 'Заказ доставлен'), ('canceled', 'Заказ отменен')], default='basket', max_length=15, verbose_name='Статус')),
        ...
        migrations.AddField(
            model_name='product',
            name='shop',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_query_name='products', to='main.shop', verbose_name='Магазин'),
        ),
        migrations.CreateModel(
            name='OrderItem',
            fields=[
